				...
				if(mysqli_num_rows($sql) > 0){
					...
					while($data = mysqli_fetch_assoc($sql)){
						...
						<tr>
							...
							<td>
								<a href="index.php?page=edit_pasien&no_rm='.$data['no_rm'].'" class="btn btn-secondary btn-sm">Edit</a>
								<a href="index.php?page=delete_pasien&no_rm='.$data['no_rm'].'" class="btn btn-danger btn-sm" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
							</td>
						</tr>
						';
						// $no++;
