<?php include('config/config.php');?>
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_POST['submit'])){
			...
			if($sql){
				echo '<script>alert("Berhasil menyimpan data."); document.location="index.php?page=tampil_pasien_PRJ";</script>';
			}else{
		...
		<form action="index.php?page=edit_pasien_PRJ&no_rm=<?php echo $no_rm; ?>" method="post">
			...
			<div class="item form-group">
				<div class="col-md-6 col-sm-6 offset-md-3">
					...
					<a href="index.php?page=tampil_pasien_PRJ" class="btn btn-warning">Kembali</a>
				</div>
			</div>
		</form>
	</div>
