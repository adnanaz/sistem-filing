<?php include('config/config.php');?>
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_POST['submit'])){
			...
			if($sql){
				echo '<script>alert("Berhasil menyimpan data."); document.location="index.php?page=tampil_peminjam";</script>';
			}else{
		...
		<form action="index.php?page=edit_peminjam&kd_peminjam=<?php echo $kd_peminjam; ?>" method="post">
			...
			<div class="item form-group">
				<div class="col-md-6 col-sm-6 offset-md-3">
					...
					<a href="index.php?page=tampil_peminjam" class="btn btn-warning">Kembali</a>
				</div>
			</div>
		</form>
	</div>
